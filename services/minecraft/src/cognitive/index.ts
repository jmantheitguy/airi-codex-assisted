...
import { AutonomyRuntime } from './autonomy/runtime'
...
export function CognitiveEngine(options: CognitiveEngineOptions): MineflayerPlugin {
  ...
  let autonomyRuntime: AutonomyRuntime | null = null
  let started = false
  ...
  return {
    async created(bot) {
      ...
      autonomyRuntime = new AutonomyRuntime({
      ...
      const startCognitive = () => {
        ...
        autonomyRuntime?.init(botWithAgents)
