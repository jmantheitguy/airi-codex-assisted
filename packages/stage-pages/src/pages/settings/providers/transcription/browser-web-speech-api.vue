  ...
  >
    <div flex="~ col md:row gap-6">
      <ProviderSettingsContainer class="w-full md:w-[40%] space-y-6">
        ...
        >
          <template #title>
            Selected device is not the recognizer input source
          </template>
          <template #content>
            Web Speech API listens to the browser or operating system default microphone. The AIRI audio device selector and meters can still show a different device, so speech may be detected locally while browser transcription stays empty.
          </template>
        </Alert>
      ...
      <div flex="~ col gap-6" class="w-full md:w-[60%]">
        <div w-full rounded-xl bg="neutral-50 dark:[rgba(0,0,0,0.3)]" p-4 flex="~ col gap-4">
          ...
          <div text="sm neutral-400 dark:neutral-500" mb-2>
            Test Web Speech API transcription. The browser recognizer will use your default microphone, not necessarily the audio device selected below.
          </div>
          ...
          <div v-else class="flex flex-col gap-4">
            ...
            <div class="flex items-center gap-2">
              <FieldSelect
                ...
                description="Used by AIRI's local audio stream and meters. Web Speech API recognition itself still uses the browser or system default microphone."
