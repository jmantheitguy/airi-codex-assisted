...
import { ChatHistory, ChatMemoryStrip, HearingConfigDialog } from '@proj-airi/stage-ui/components'
    ...
    <KeepAlive>
      <Transition name="fade">
        <div
          ...
          :class="['relative z-20', 'flex flex-col gap-2']"
        >
          <ChatMemoryStrip variant="mobile" />
          <ChatHistory
            variant="mobile"
