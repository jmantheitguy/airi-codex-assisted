...
export interface KokoroFallbackVoice {
  id: string
  name: string
  gender: string
  languageCode: string
...
export const KOKORO_FALLBACK_VOICES: KokoroFallbackVoice[] = [
  { id: 'af_bella', name: 'Bella', gender: 'female', languageCode: 'en-US', languageTitle: 'English (US)' },
  { id: 'af_sarah', name: 'Sarah', gender: 'female', languageCode: 'en-US', languageTitle: 'English (US)' },
  { id: 'af_nicole', name: 'Nicole', gender: 'female', languageCode: 'en-US', languageTitle: 'English (US)' },
  { id: 'af_sky', name: 'Sky', gender: 'female', languageCode: 'en-US', languageTitle: 'English (US)' },
  { id: 'am_adam', name: 'Adam', gender: 'male', languageCode: 'en-US', languageTitle: 'English (US)' },
  { id: 'am_michael', name: 'Michael', gender: 'male', languageCode: 'en-US', languageTitle: 'English (US)' },
  { id: 'bf_emma', name: 'Emma', gender: 'female', languageCode: 'en-GB', languageTitle: 'English (UK)' },
  { id: 'bf_isabella', name: 'Isabella', gender: 'female', languageCode: 'en-GB', languageTitle: 'English (UK)' },
  { id: 'bm_george', name: 'George', gender: 'male', languageCode: 'en-GB', languageTitle: 'English (UK)' },
  { id: 'bm_lewis', name: 'Lewis', gender: 'male', languageCode: 'en-GB', languageTitle: 'English (UK)' },
]
...
export function kokoroFallbackVoicesToVoiceInfo(provider: string) {
  return KOKORO_FALLBACK_VOICES.map(voice => ({
    id: voice.id,
    name: `${voice.name} (${voice.gender}, ${voice.languageTitle})`,
    provider,
    languages: [{ code: voice.languageCode, title: voice.languageTitle }],
    gender: voice.gender,
  }))
}
