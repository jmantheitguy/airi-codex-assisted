...
const LEGACY_DEFAULT_CHAT_MODELS = new Set(['gpt-4o-mini', 'gpt-5-nano', 'gpt-4.1-nano', 'gpt-5.5-instant'])
...
export const useConsciousnessStore = defineStore('consciousness', () => {
  ...
  if (activeProvider.value === DEFAULT_CHAT_PROVIDER && LEGACY_DEFAULT_CHAT_MODELS.has(activeModel.value)) {
    activeModel.value = DEFAULT_CHAT_MODEL
  }
