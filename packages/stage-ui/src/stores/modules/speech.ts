...
export const useSpeechStore = defineStore('speech', () => {
  ...
  // State
  const activeSpeechProvider = useLocalStorageManualReset<string>('settings/speech/active-provider', DEFAULT_SPEECH_PROVIDER)
  const activeSpeechModel = useLocalStorageManualReset<string>('settings/speech/active-model', DEFAULT_SPEECH_MODEL)
  const activeSpeechVoiceId = useLocalStorageManualReset<string>('settings/speech/voice', DEFAULT_SPEECH_VOICE_ID)
